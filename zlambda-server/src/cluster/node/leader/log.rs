...
pub struct LeaderNodeActorLogEntries {
    log_entries: HashMap<LogEntryId, LeaderNodeLogEntry>,
...
impl LeaderNodeActorLogEntries {
    pub fn get(&self, id: LogEntryId) -> Option<&LeaderNodeLogEntry> {
    ...
    pub fn begin(&mut self, r#type: LogEntryType, nodes: HashSet<NodeId>) -> LogEntryId {
        ...
        self.log_entries.insert(
            id,
            LeaderNodeLogEntry::new(id, r#type, nodes, HashSet::default()),
        );
